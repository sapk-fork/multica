...
export const MODEL_PRICING: Readonly<Record<string, {
  ...
  "deep-research-max-preview-04-2026": { input: 2, output: 12, cacheRead: 0.2, cacheWrite: 2 },
  "deep-research-preview-04-2026": { input: 2, output: 12, cacheRead: 0.2, cacheWrite: 2 },
  "deepseek-chat": { input: 0.14, output: 0.28, cacheRead: 0.0028, cacheWrite: 0.14 },
  "deepseek-flash": { input: 0.15, output: 0.6, cacheRead: 0.003, cacheWrite: 0.15 },
  ...
  "deepseek-v4-flash-vision-exp": { input: 0.14, output: 0.28, cacheRead: 0.0028, cacheWrite: 0.14 },
  ...
  "gemini-3.1-flash-lite-image": { input: 0.25, output: 30, cacheRead: 0.25, cacheWrite: 0.25 },
  "gemini-3.1-flash-lite-preview": { input: 0.25, output: 1.5, cacheRead: 0.025, cacheWrite: 0.25 },
  "gemini-3.1-flash-live-preview": { input: 0.75, output: 4.5, cacheRead: 0.75, cacheWrite: 0.75 },
  "gemini-3.1-flash-tts-preview": { input: 1, output: 20, cacheRead: 1, cacheWrite: 1 },
  ...
  "github-copilot/gpt-5.6-sol": { input: 4, output: 20, cacheRead: 0.4, cacheWrite: 5 },
  ...
  "glm-4.6v": { input: 0.3, output: 0.9, cacheRead: 0.3, cacheWrite: 0.3 },
  ...
  "gpt-5.1-codex": { input: 1.07, output: 8.5, cacheRead: 0.107, cacheWrite: 1.07 },
  ...
  "muse-spark-1.2-contributor": { input: 0.1, output: 0.2, cacheRead: 0.002, cacheWrite: 0.1 },
  "muse-spark-1.3": { input: 1.25, output: 4.25, cacheRead: 0.15, cacheWrite: 1.25 },
  "muse-spark-1.3-contributor": { input: 0.1, output: 0.2, cacheRead: 0.002, cacheWrite: 0.1 },
  ...
  "omen-alpha": { input: 0.2, output: 0.66, cacheRead: 0.04, cacheWrite: 0.2 },
  ...
  "opencode-go/deepseek-v4-flash": { input: 0.15, output: 0.6, cacheRead: 0.003, cacheWrite: 0.15 },
  "opencode-go/deepseek-v4-flash-vision-exp": { input: 0.15, output: 0.6, cacheRead: 0.003, cacheWrite: 0.15 },
  ...
  "opencode-go/glm-5.3-flash": { input: 0.15, output: 0.5, cacheRead: 0.03, cacheWrite: 0.15 },
  ...
  "opencode/deepseek-v4-flash-vision-exp": { input: 0.14, output: 0.28, cacheRead: 0.028, cacheWrite: 0.14 },
  "opencode/deepseek-v4-pro": { input: 1.74, output: 3.84, cacheRead: 0.145, cacheWrite: 1.74 },
  "opencode/gemini-3.6-flash": { input: 1.5, output: 7.5, cacheRead: 0.15, cacheWrite: 1.5 },
  "opencode/gemini-3.7-flash": { input: 1.5, output: 7.5, cacheRead: 0.15, cacheWrite: 1.5 },
  "opencode/gemini-3.8-flash": { input: 1.5, output: 7.5, cacheRead: 0.15, cacheWrite: 1.5 },
  ...
  "opencode/glm-5.3": { input: 1.4, output: 4.4, cacheRead: 0.26, cacheWrite: 1.4 },
  "opencode/glm-5.3-flash": { input: 0.15, output: 0.5, cacheRead: 0.03, cacheWrite: 0.15 },
