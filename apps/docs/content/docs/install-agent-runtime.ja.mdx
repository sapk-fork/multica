...
ACP プロトコルのエージェントで、主に中国市場を対象としています。スキルは `.kimi/skills/` 配下に置かれます（ネイティブ発見）。バイナリ名は `kimi` のままです。

| | |
|---|---|
| デーモンが探す名前 | `kimi` |
| インストール | [github.com/MoonshotAI/kimi-code](https://github.com/MoonshotAI/kimi-code) の公式ガイドに従ってください。 |
