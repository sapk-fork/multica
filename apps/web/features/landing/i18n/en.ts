    ...
    entries: [
      ...
      },
      {
        ...
        features: [
          ...
          "Kimi Code CLI as a new agent runtime (Moonshot AI's `kimi-code` over ACP), with model selection, auto-approved tool permissions, and streaming tool-call rendering",
